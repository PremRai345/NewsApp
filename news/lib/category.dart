...
class _CategoryState extends State<Category> {
  ...
  getNewsByQuery(String query) async {
    ...
    if (query == 'Top News' || query == 'United Kingdom') {
      String url =
          "https://newsapi.org/v2/everything?q=tesla&from=2022-05-28&sortBy=publishedAt&apiKey=b8fc250dcc50454e9d55db485e94c195";
    } else {
      String url =
          "https://newsapi.org/v2/everything?q=$query&from=2022-06-27&sortBy=popularity&apiKey=b8fc250dcc50454e9d55db485e94c195";
    }
